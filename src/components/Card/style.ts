...
export const categoryCardWrapper = css({
  ...
  alignItems: "center",
  shadow: "lg",
  gradient: 'var(--colors-neutral-100, #170D19)',
  rounded: "xl",
  ...
  _hover: {
    color: "white",
    gradient: '129.59deg, #FF01B8 2.58%, #FF6865 95.56%',
...
export const finantialCardWrapper =  css({
  ...
  p: "12px",
  width: "180px",
  gradient: '128.58deg, #00000000 63.84%, #cc95d726 96.69%',
  _hover: {
    gradient: '129deg, #0000 63.84%, #ff00b833 96.69%',
    translate: "auto",
    translateY: "-2%",
    cursor: "pointer",
